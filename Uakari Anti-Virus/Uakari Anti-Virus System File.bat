...
:menu
cls
echo Uakari Anti-Virus                                                                                            Version 1.3
...
echo [   [        0       0             ]                           Options:                                                ]
echo [   [          0   0               ]                                                                                   ]
echo [   [            0                 ]                           [1] PC Clean-UP                                         ]
echo [   [                              ]                           [2] Scan For Viruses                                    ]
echo [   ________________________________                           [3] List Currently Running Programs                     ]
echo [                 000                                          [4] Exit Uakari Anti-Virus                              ]
echo [                 000                                          [5] Update Uakari Anti-Virus                            ]
echo [             00000000000                                                                                              ]
echo [                                                                                                                      ]
echo [             You Are Safe                                                                                             ]
echo [                                                                                                                      ]
